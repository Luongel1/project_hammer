...
Future research could expand this work by incorporating product-specific attributes, seasonal factors, and promotional data to capture a broader range of influences on grocery prices. Analyzing the correlation between demographic factors (e.g., income levels) and price patterns across vendors could reveal socio-economic impacts on different communities.

Increasing the model’s granularity to examine price dynamics at the regional or product-category level would provide deeper insights into pricing variations within stores or across regions. Additionally, including online grocery prices or specialty stores could offer a more comprehensive view of the Canadian market.

Applying machine learning techniques could enhance the model’s adaptability to rapidly changing market conditions, enabling more precise forecasts, especially amid challenges like inflation and supply chain disruptions, benefiting policymakers and consumers in understanding and managing grocery costs.
